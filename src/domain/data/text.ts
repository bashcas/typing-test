const text = `We know sharks are dangerous but do you know that there is a more dangerous animal we can find on a farm? While sharks kill an average of 5 people a year, cows kill an average of 33 people every year.
...
Almost all 197 countries in the world have a real-life animal as their national animal, but 6 of them have mythical animals. Scotland, for example, appointed the unicorn as their national animal.
It might come as no surprise that guitars are the most popular music instrument, followed closely by pianos. However, neither of them are the best-selling instruments. That title goes to the harmonica!
...
In 1998, Sony had the chance to buy the rights to most of the Marvel characters. However, they only bought the rights for Spider-Man, stating that no one cares about the other characters.
...
Max Planck was the founder of quantum theory and a Nobel Prize winner. However, when he went to study physics, his professor told him that almost everything had already been discovered.
...
Pokemon is currently the highest-grossing media franchise. This is followed, by a large difference, by Hello Kitty, Winnie the Pooh, Mickey Mouse, and then Star Wars, despite their resounding success.
While Pokemon is the highest-grossing media franchise of all time, it is surprisingly not the best-selling game. In fact, it's not even in the top 3. Currently, Minecraft is the best-selling game.
...
Even though the Mall of America is located in Minnesota, where it can get pretty cold, they do not have any centralized heating. Instead, the heat is generated from lighting, body heat, and sunlight.
